...
const UCOS = () => import('@/components/ucos/UCOS')
...
router.beforeEach((to, from, next) => {
  var allowPath = ['/home', '/changeemail', '/changepsw', '/navigation']
  // console.log(localStorage.getItem('ucos'));

  if (localStorage.getItem('ucos')=='true') {
    allowPath.push('/ucos')
  }
  var pathObj = {
