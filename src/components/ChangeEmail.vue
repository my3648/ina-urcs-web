  ...
  <div class="login-container">
    ...
    <div class="out">
      ...
      <el-form :model="ruleForm" :rules="rules" status-icon ref="ruleForm" label-position="left" label-width="0px"
        ...
        <h3 class="title">修改email/phone</h3>
        ...
        <el-form-item prop="email">
          <el-input type="text" @keyup.enter.native="handleSubmit" v-model="ruleForm.email"
            auto-complete="off" placeholder="请输入email地址"></el-input>
        </el-form-item>
        <el-form-item prop="phone">
          <el-input type="text" @keyup.enter.native="handleSubmit" v-model="ruleForm.phone"
            auto-complete="off" placeholder="请输入电话号码"></el-input>
        </el-form-item>
