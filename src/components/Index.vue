<template>
  <div class="index">
    ...
    <div style="margin-bottom:0.3em">
      <el-select clearable v-model="domains.projectId" filterable placeholder="project no.">
        <el-option v-for="item in projectNumberList" :key="item" :label="item" :value="item">
        </el-option>
      </el-select>
      <el-select clearable v-model="domains.vehicleId" filterable placeholder="vehicle no.">
        <el-option v-for="item in carNumberList" :key="item" :label="item" :value="item">
        </el-option>
      </el-select>
      <el-select clearable v-model="domains.deviceId" filterable placeholder="device no.">
        <el-option v-for="item in deviceNumberList" :key="item" :label="item" :value="item">
        </el-option>
      </el-select>
    </div>
    <div style="margin-bottom:0.3em">
      <el-select clearable v-model="domains.workPackage" filterable placeholder="package">
        <el-option v-for="item in workPackageList" :key="item" :label="item" :value="item">
        </el-option>
      </el-select>
      <el-select clearable v-model="domains.task" filterable placeholder="test item">
    ...
    <el-table ref="multipleTable" v-loading="loading" :data="tableData" tooltip-effect="dark" style="width: 100%"
      ...
      <el-table-column min-width="16%" sortable="custom" prop="startTime" label="time">
      </el-table-column>
      <el-table-column min-width="8%" prop="fileSize" sortable="custom" label="size">
        <template slot-scope="scope">
      ...
      if (obj.order == "ascending") {
        ...
        this.result = this.Allresult.filter(
          (data) =>
            ...
            data.startTime.toLowerCase().includes(val.toLowerCase())
        );
      }
