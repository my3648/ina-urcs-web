  ...
  <div class="ucos">
    <el-container>
      <el-header>
        ...
        <el-menu class="el-menu-demo" mode="horizontal" @select="handleSelect" background-color="#545c64"
          text-color="#fff" active-text-color="#ffd04b" style="overflow:hidden">
    ...
    更多菜单<i class="el-icon-arrow-down el-icon--right"></i>
      ...
      <el-main>
        ...
        <div style="width:80%;max-width:1380px;margin:0 auto;position:relative">
          <div v-show="!mainArea">
        ...
        <el-dialog title="提交进度" :show-close="false" :close-on-click-modal="false" :visible.sync="dialogVisible" width="20%">
...
export default {
  ...
  data() {
    return {
      ...
      // areaList: [24, 28, 13, 30, 31, 40, 41, 48, 15, 18], //单独的Area 序号  （与通用currentView区分）
      currentFileList: {
        //通用上传文件区域是否存在
        1: true,
        2: true,
  ...
  methods: {
    ...
    selectMenu(func, group, name) {
      ...
      console.log(this.currentFileList[index]);
...
.ucos .el-container:nth-child(5) .el-aside,
...
.ucos .label.require::before {
  content: "*";
  color: #f56c6c;
  margin-right: 4px;
}
.ucos .el-form-item__label {
  font-size: 15px;
  font-weight: 550;
}
.ucos .cell.require::before {
  content: "*";
  color: #f56c6c;
  margin-right: 4px;
}
