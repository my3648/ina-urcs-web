  ...
  <div class="overview" style="margin:0 auto;width:1100px;">
    ...
    <div v-if="username!='admin'">
      <h3 style="position:relative">
        设备借用申请
        <el-input size="mini" style="position:absolute;width:150px;top:0;right:0" v-model="searchValBor"
      ...
      this.$http
        ...
        .then((res) => {
          ...
          if (res.data.res == "V") {
            ...
            if (res.data.data) {
              this.allresultBor = res.data.data;
            }
