...
export default {
  ...
  data() {
    return {
      ...
      funcSearch: "",
      boxData: ['UA0001','UA0002','UA0003','UA0004','UA0005','UA0006','UA0007','UA0008','UA0009','UA0010'],
          ...
          .then((res) => {
            ...
            if (res.data.res == "V") {
              ...
              // if (!this.boxData.includes("UA0001")) {
                // this.boxData.push("UA0001");
                // this.boxData.push("UA0002");
                // this.boxData.push("UA0003");
                // this.boxData.push("UA0004");
                // this.boxData.push("UA0005");
                // this.boxData.push("UA0006");
                // this.boxData.push("UA0007");
                // this.boxData.push("UA0008");
                // this.boxData.push("UA0009");
                // this.boxData.push("UA0010");
              // }
            } else {
              this.$message({
                type: "warning",
